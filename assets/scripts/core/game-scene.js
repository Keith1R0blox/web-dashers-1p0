...
this._menuUpdateLogBtn = this.add.image(screenWidth - 30 - 50, 33, "GJ_WebSheet", "GJ_infoIcon_001.png").setScrollFactor(0).setDepth(30).setScale(0.64).setTint(Phaser.Display.Color.GetColor(255, 255, 255)).setInteractive();
    ...
    this._menuSettingsBtn = this.add.image(centerX + 152, screenHeight - 90, "GJ_GameSheet03", "GJ_optionsBtn_001.png").setScrollFactor(0).setDepth(30).setInteractive();
    ...
    this._menuStatsBtn = this.add.image(centerX + 262, screenHeight - 90, "GJ_GameSheet03", "GJ_statsBtn_001.png").setScrollFactor(0).setDepth(30).setInteractive();
    this._expandHitArea(this._menuStatsBtn, 1);
    this._makeBouncyButton(this._menuStatsBtn, 1, () => {
      this._showStatsScreen();
    }, () => this._menuActive);
    this._menuAchievementsBtn = this.add.image(centerX + 42, screenHeight - 90, "GJ_GameSheet03", "GJ_achBtn_001.png").setScrollFactor(0).setDepth(30).setInteractive().setTint(0x666666);
    ...
    this._openSearchMenu = () => {
      ...
      const placeholderLabel = this.add.bitmapText(inputCX - 5, inputCY, "bigFont", "Enter a level or id", 28)
...
"player_11_001.png", "player_12_001.png", "player_13_001.png",
      ]
    };
    ...
    topBar.strokePath();
      ...
      const prevArrow = this.add.image(containerX - arrowMargin, arrowY, "GJ_GameSheet03", "transparent.png")
