...
class A extends Phaser.Scene {
  ...
  preload() {
    ...
    barBg.fillRoundedRect(barX - 2, barY - 2, barW + 4, 22, 10);
    barBg.fillStyle(0x001133, 1);
    barBg.fillRoundedRect(barX, barY, barW, 18, 8);
    const barFill = this.add.graphics();
    const pctText = this.add.text(cx, barY + 18 + 18, '0%', {
      fontSize: '14px',
      fontFamily: 'Arial',
      color: '#6699ff'
    }).setOrigin(0.5, 0);
    ...
    const consoleY = barY + 18 + 44;
    const consoleBg = this.add.graphics();
    consoleBg.fillStyle(0x000811, 1);
    consoleBg.fillRoundedRect(consoleX, consoleY, barW, 120, 6);
    consoleBg.lineStyle(1, 0x112244, 1);
    consoleBg.strokeRoundedRect(consoleX, consoleY, barW, 120, 6);
    ...
    const pushLine = line => {
      ...
      if (consoleLines.length > 8) {
        consoleLines.shift();
      }
      consoleText.setText(consoleLines.join("\n"));
    };
    this.load.on('fileprogress', file => {
      const prev = fileBytesMap[file.key] || {
        loaded: 0,
        total: 0
      };
      ...
      if (nowTotal > prev.total) {
        totalExpectedBytes += nowTotal - prev.total;
      }
      fileBytesMap[file.key] = {
        loaded: nowLoaded,
        total: nowTotal
      };
      const remaining = Math.max(0, totalExpectedBytes - totalLoadedBytes);
      const remMB = (remaining / 1048576).toFixed(2);
    ...
    this.load.on('filecomplete', (key, type) => {
      const entry = fileBytesMap[key] || {
        loaded: 0,
        total: 0
      };
      const sizeMB = (entry.total / 1048576).toFixed(2);
      if (consoleLines.length > 0) {
    ...
    this.load.on("progress", value => {
      ...
      barFill.fillRoundedRect(barX, barY, fillW, 18, 8);
      barFill.fillStyle(0x4488ff, 0.5);
      barFill.fillRoundedRect(barX, barY, fillW, 9, {
        tl: 8,
        tr: 8,
        bl: 0,
        br: 0
...
class us {
  ...
  _buildGround() {
    ...
    for (let _0x3a0baf = 0; _0x3a0baf < _0x5bf5f8; _0x3a0baf++) {
      ...
      let _0x929a9b = _0x73ae12.add.image(0, 460, "groundSquare_" + window._groundId + "_001.png");
      ...
      let _0x1b177f = _0x73ae12.add.image(0, 460, "groundSquare_" + window._groundId + "_001.png");
    ...
    this._groundLine = _0x73ae12.add.image(r / 2, 459, "GJ_WebSheet", "floorLine_01_001.png").setOrigin(0.5, 0).setScale(_0x578262, 1).setBlendMode(S).setDepth(21).setScrollFactor(0);
    this._ceilingLine = _0x73ae12.add.image(r / 2, 461, "GJ_WebSheet", "floorLine_01_001.png").setOrigin(0.5, 1).setScale(_0x578262, 1).setFlipY(true).setBlendMode(S).setDepth(21).setScrollFactor(0).setVisible(false);
    this._groundShadowL = _0x73ae12.add.image(-1, 460, "GJ_WebSheet", "groundSquareShadow_001.png").setOrigin(0, 0).setScrollFactor(0).setDepth(22).setAlpha(0.39215686274509803).setScale(0.7, 1).setBlendMode(E);
    this._groundShadowR = _0x73ae12.add.image(r + 1, 460, "GJ_WebSheet", "groundSquareShadow_001.png").setOrigin(1, 0).setScrollFactor(0).setDepth(22).setAlpha(0.39215686274509803).setScale(0.7, 1).setFlipX(true).setBlendMode(E);
    this._ceilingShadowL = _0x73ae12.add.image(-1, 460, "GJ_WebSheet", "groundSquareShadow_001.png").setOrigin(0, 1).setScrollFactor(0).setDepth(22).setAlpha(0.39215686274509803).setScale(0.7, 1).setFlipY(true).setBlendMode(E).setVisible(false);
    this._ceilingShadowR = _0x73ae12.add.image(r + 1, 460, "GJ_WebSheet", "groundSquareShadow_001.png").setOrigin(1, 1).setScrollFactor(0).setDepth(22).setAlpha(0.39215686274509803).setScale(0.7, 1).setFlipX(true).setFlipY(true).setBlendMode(E).setVisible(false);
  }
  resizeScreen() {
    var _0xdc60af;
    var _0x493047;
    ...
    while (this._groundTiles.length < _0x546bad) {
      ...
      console.log(window._groundId);
      let _0x32bd97 = _0x1f0ac2.add.image(0, 460, "groundSquare_" + window._groundId + "_001.png");
      ...
      let _0x6e7d76 = _0x1f0ac2.add.image(0, 460, "groundSquare_" + window._groundId + "_001.png");
  ...
  updateGroundTiles(_0x14aed2 = 0) {
    ...
    if (this._flyVisualOnly && this._flyCeilingY !== null) {
      ...
      _0x3453a2 = 460 - this._flyCeilingY + _0x14aed2;
    } else if (this._flyGroundActive && this._groundTargetValue > 0.001) {
      let _0x3ce536 = this._groundTargetValue;
      _0x12b0b9 = this._groundStartScreenY + (620 - this._groundStartScreenY) * _0x3ce536;
      _0x3453a2 = this._ceilingStartScreenY + (20 - this._ceilingStartScreenY) * _0x3ce536;
  ...
  _computeFlyBounds(_0x804885, _0x4dbd1c = 600, _0x354ea0 = false) {
    let _0x4dd75a;
    if (_0x354ea0) {
      _0x4dd75a = _0x804885 - 300;
    } else {
      _0x4dd75a = _0x804885 - _0x4dbd1c / 2;
    }
    _0x4dd75a = Math.floor(_0x4dd75a / 60) * 60;
  ...
  setFlyMode(_0x4a6d9a, _0x3a58e7, _0x8d8ff0 = 600, _0x47bce0 = false) {
    if (_0x4a6d9a) {
      ...
      this.flyCameraTarget = _0x15ff58 - 320 + 180;
  ...
  _spawnLevelObjects(_0x35f1ae) {
    ...
    for (let _0x1b937f of _0x35f1ae) {
      let _0x24471f = allObjects[id] || null;
      if (_0x24471f && _0x24471f.type === "trigger") {
      ...
      if (_0x4c7589) {
        let _0x1b10a0 = 460 - _0x7ab528;
        const _0x501fde = (_0x24471f.type === "portal" || _0x24471f.type === "speed") && _0x4c7589.includes("_front_");
        if (_0x501fde) {
        ...
        let _0xOrbGlow = null;
        if (_0x24471f.glow) {
          _0xOrbGlow = this._addGlowSprite(_0xd15974, _0x173c58, _0x1b10a0, _0x4c7589, _0x1b937f, _0x173c58);
        }
        ...
        if (_0x554e0e) {
          ...
          if (_0x24471f && _0x24471f.type === "ring") {
        ...
        if (_0x24471f && (_0x24471f.type === "solid" || _0x24471f.type === "hazard")) {
      ...
      if (_0x24471f && _0x24471f.portalParticle && _0x4c7589) {
        ...
        let _0x1bed6b = _0xd15974.add.particles(_0x5926ad, _0x2e9079, "GJ_WebSheet", {
          ...
          emitCallback: _0x157c59 => {
            ...
            let _0x1e162a = (_0x42124a - 20) / (_0x1d5ab8 || 0.3);
      ...
      if (_0x24471f) {
        if (_0x24471f.type === "solid" && _0x24471f.gridW > 0 && _0x24471f.gridH > 0) {
          let _0x10e5ae = _0x24471f.gridW * 60;
          let _0x11e08d = _0x24471f.gridH * 60;
          let _0x4628ff = new Collider("solid", _0x173c58, _0x7ab528, _0x10e5ae, _0x11e08d, _0x1b937f.rot || 0);
          _0x4628ff.objid = _0x1b937f.id;
          this.objects.push(_0x4628ff);
          this._addCollisionToSection(_0x4628ff);
        } else if (_0x24471f.type === "hazard") {
          let _0x3f8c4f = 0;
          let _0x2a123d = 0;
          ...
          if (_0x3f8c4f > 0 && _0x2a123d > 0) {
            let _0x3c84ad = new Collider("hazard", _0x173c58, _0x7ab528, _0x3f8c4f, _0x2a123d, _0x1b937f.rot || 0);
            this.objects.push(_0x3c84ad);
            this._addCollisionToSection(_0x3c84ad);
          }
        } else if (_0x24471f.type === "portal") {
          let _0x2c2226 = _0x24471f.gridH * 60;
          ...
          if (_0x25452a) {
            let _0x4bd7bc = new Collider(_0x25452a, _0x173c58, _0x7ab528, 90, _0x2c2226, _0x1b937f.rot || 0);
            _0x4bd7bc.portalY = _0x7ab528;
            this.objects.push(_0x4bd7bc);
            this._addCollisionToSection(_0x4bd7bc);
            console.log("portal collision created: type=" + _0x25452a + " id=" + _0x1b937f.id + " x=" + _0x173c58 + " y=" + _0x7ab528 + " w=" + 90 + " h=" + _0x2c2226);
          } else {
            console.warn("portal ID " + _0x1b937f.id + " has no matching sub-type (sub=" + _0x24471f.sub + ")");
          }
        } else if (_0x24471f.type === "pad") {
          let padW = _0x24471f.gridW * 60;
          let padH = Math.max(_0x24471f.gridH, 10);
          let padObj = new Collider("jump_pad", _0x173c58, _0x7ab528, padW, padH, _0x1b937f.rot || 0);
        ...
        } else if (_0x24471f.type === "ring") {
          let orbW = _0x24471f.gridW * 60 * 0.8;
          let orbH = _0x24471f.gridH * 60 * 0.8;
          let orbObj = new Collider("jump_ring", _0x173c58, _0x7ab528, orbW, orbH, _0x1b937f.rot || 0);
  ...
  createEndPortal(_0x41fbdb) {
    ...
    for (let _0x2a327c = 0; _0x2a327c < _0x46064b; _0x2a327c++) {
      const _0xacf7ef = _0x41fbdb.add.image(0, (_0x2a327c - Math.floor(_0x46064b / 2)) * 60, "GJ_WebSheet", "square_02_001.png").setAngle(-90);
      this._endPortalContainer.add(_0xacf7ef);
    }
    this.container.add(this._endPortalContainer);
    this._endPortalShine = _0x41fbdb.add.image(_0x3b56d4 - 58, 220, "GJ_WebSheet", "gradientBar.png");
  ...
  applyEnterEffects(_0x2f36ed) {
    ...
    const _0x2d8f53 = Math.max(0, Math.floor((_0x2f36ed - 140) / 400));
    const _0x2b19db = Math.min(this._sections.length - 1, Math.floor((_0x548004 + 140) / 400));
    for (let _0x1bd44f = _0x2d8f53; _0x1bd44f <= _0x2b19db; _0x1bd44f++) {
      const _0x2cff29 = this._sections[_0x1bd44f];
      if (!_0x2cff29) {
        continue;
      }
      const _0x20a3bb = _0x1bd44f * 400;
      const _0x8f9d56 = _0x20a3bb >= _0x2f36ed + 140 && _0x20a3bb + 400 <= _0x548004 - 140;
      for (let _0x54aba7 = 0; _0x54aba7 < _0x2cff29.length; _0x54aba7++) {
        ...
        let _0x289aa2;
        _0x289aa2 = _0x1b2883 ? Math.max(0, Math.min(1, (_0x548004 - _0xeded99) / 140)) : Math.max(0, Math.min(1, (_0xeded99 - _0x2f36ed) / 140));
        if (_0x289aa2 >= 1) {
          if (_0x2ae6ed._eeActive) {
            _0x2ae6ed._eeActive = false;
            _0x2ae6ed.y = _0x2ae6ed._eeBaseY;
        ...
        switch (_0x453353) {
          case 0:
            break;
          case 1:
            _0x50e6d9 = _0x2ae6ed._eeBaseY + 200 * _0x20804e;
            break;
          case 2:
            _0x50e6d9 = _0x2ae6ed._eeBaseY - 200 * _0x20804e;
            break;
          case 3:
            _0x17437c = _0x2ae6ed._eeWorldX - 200 * _0x20804e;
            break;
          case 4:
            _0x17437c = _0x2ae6ed._eeWorldX + 200 * _0x20804e;
            break;
...
class ps {
  ...
  _createSprites() {
    ...
    if (this._playerSpriteLayer) {
      ...
      let _0x3aecd9 = _0x1872a7.add.rectangle(_0xf42f36, _0x28689a, 60, 60, window.mainColor);
  ...
  _updateParticles(_0xc43238, _0x52b718, _0x5af874) {
    ...
    this._shipDragEmitter.particleY = this.p.gravityFlipped ? 460 - this.p.y + _0x52b718 - 30 : 460 - this.p.y + _0x52b718 + 30;
  ...
  syncSprites(cameraX, cameraY, _0x3afedf, mirrorOffset) {
    ...
    const _0x1a433c = 460 - this.p.y + cameraY;
    ...
    if (this.p.isFlying) {
      ...
      const _0x1b1d28 = -10 * _0x501bf9;
      const _0x185f91 = 10 * _0x285611;
  ...
  enterShipMode(_0xeb37c6 = null) {
    ...
    this._gameLayer.setFlyMode(true, _0x17d728, 600, false);
  }
  exitShipMode() {
    if (this.p.isFlying) {
  ...
  enterBallMode(_0x36bb3d = null) {
    ...
    this._gameLayer.setFlyMode(true, _0x18df19 + 60, 480, true);
  }
  exitBallMode() {
    if (!this.p.isBall) {
      return;
  ...
  enterWaveMode(_0x5a10cc = null) {
    ...
    this._gameLayer.setFlyMode(true, _0x38b484, 600, false);
  }
  exitWaveMode() {
    if (!this.p.isWave) {
      return;
  ...
  hitGround() {
    ...
    if (_0x4a38a5 && !this.p.isFlying && !this.p.isWave) {
      ...
      const _0x17e0bb = this.p.gravityFlipped ? 460 - this.p.y - 30 : 460 - this.p.y + 30;
  ...
  killPlayer() {
    ...
    const _0x53ac5b = 460 - this.p.y + this._lastCameraY;
    ...
    _0x3f4b84.tweens.add({
      ...
      onUpdate: () => {
        _0x438d80.clear();
        _0x438d80.fillStyle(window.mainColor, 1);
  ...
  _createExplosionPieces(_0x49be85, _0x13b56e, _0x349a09) {
    ...
    for (let _0x3f4d44 = 0; _0x3f4d44 < _0x28c600 - 1; _0x3f4d44++) {
      const _0x5b2c12 = Math.round(_0x5e8097 * (0.55 + Math.random() * 0.45 * 2));
    ...
    for (let _0x325ce1 = 0; _0x325ce1 < _0x247253 - 1; _0x325ce1++) {
      const _0x37f0ad = Math.round(_0x5af9d3 * (0.55 + Math.random() * 0.45 * 2));
    ...
    for (let _0x4cd06e = 0; _0x4cd06e < _0x28c600; _0x4cd06e++) {
      ...
      for (let _0x5b14cf = 0; _0x5b14cf < _0x247253; _0x5b14cf++) {
        ...
        if (_0x156c8b % 2 == 0) {
          ...
          _0x298d34 = _0x44acaf.add.particles(0, 0, "GJ_WebSheet", {
            ...
            emitCallback: _0x2f7fc7 => {
              _0x2f7fc7.x = _0xba83f5.x + (Math.random() * 2 - 1) * 3 * 2;
              _0x2f7fc7.y = _0xba83f5.y + (Math.random() * 2 - 1) * 3 * 2;
            }
          });
        ...
        const _0x159cfa = {
          spr: _0xba83f5,
          particle: _0x298d34,
          xVel: 3.7389612960000003 + (Math.random() * 2 - 1) * 7.4779225920000005,
  ...
  _playPortalShine(_0x49e81f) {
    ...
    const _0x3824c0 = 460 - _0x49e81f.portalY;
  ...
  _checkSnapJump(_0x1f801b) {
    ...
    if (_0x2b806a && _0x2b806a !== _0x1f801b && _0x2b806a.type === "solid") {
  ...
  updateGroundRotation(_0x5c24f7) {
    ...
    let _0x17a9a6 = Math.min(_0x5c24f7 * 1, 0.47250000000000003 * _0x5c24f7);
  ...
  updateBallRoll(_0x1dd8af, onSurface) {
    ...
    this._rotation += _0x1dd8af / 30 * _0x136f29 * speedFactor;
  }
  updateShipRotation(_0x217ad3) {
    ...
    if (_0x58cb3a * _0x58cb3a + _0x48f422 * _0x48f422 >= _0x217ad3 * 0.6) {
      ...
      let _0x1857d4 = Math.min(_0x217ad3 * 1, 0.15 * _0x217ad3);
  ...
  updateJump(_0x3d1c6f) {
    ...
    if (this.p.isFlying) {
      ...
      if (this.playerIsFalling()) {
        let _0x47ed2a;
        _0x47ed2a = this.p.gravityFlipped ? this.p.yVelocity > 7.665592 : this.p.yVelocity < -7.665592;
        if (_0x47ed2a) {
          this.p.onGround = false;
        }
      }
  ...
  _updateBallJump(_0x2fe319) {
    ...
    this.p.yVelocity -= 1.1498388 * _0x2fe319 * this.flipMod();
    if (this.p.gravityFlipped) {
      this.p.yVelocity = Math.min(this.p.yVelocity, 30);
    } else {
      this.p.yVelocity = Math.max(this.p.yVelocity, -30);
    ...
    if (this.playerIsFalling()) {
      const _0x1439be = this.p.gravityFlipped ? this.p.yVelocity > 7.665592 : this.p.yVelocity < -7.665592;
      if (_0x1439be) {
        this.p.onGround = false;
      }
    }
  ...
  _updateWaveJump() {
    let _0x312a7f = (this.p.upKeyDown ? 1 : -1) * this.flipMod() * 10.3860036;
    if (this.p.onGround) {
  ...
  checkCollisions(_0x2f5078) {
    ...
    for (let gameObj of _0x198534) {
      ...
      if (!(_0x3c691e + 30 <= rotatedLeft) && !(_0x3c691e - 30 >= rotatedRight) && !(_0x8e0d28 + 30 <= rotatedTop) && !(_0x8e0d28 - 30 >= rotatedBottom)) {
        ...
        if (_colType === "portal_fly") {
          ...
          if (!gameObj.activated) {
            ...
            if (_padId === 3005) {
              ...
              const _spCeil = this._gameLayer.getCeilingY() || 600;
              if (!this.p.gravityFlipped) {
                this.p.y = _spCeil - 30;
              } else {
              ...
              if (this.p.isFlying) {
                if (_padId === 35) {
                  _padVel = 30.662368;
                  _padNextTickVel = _fm * 8 * 1.916398;
                } else if (_padId === 140) {
                  _padVel = 10.731828799999999;
                } else if (_padId === 1332) {
                  _padVel = 19.31729184;
                } else if (_padId === 67) {
                  _padVel = 12.264947200000002;
                  _padFlip = true;
                }
              } else if (this.p.isBall) {
                if (_padId === 35) {
                ...
                if (_padId === 35) {
                  ...
                  _padVel = 19.930539200000002;
                } else if (_padId === 1332) {
                  _padVel = 38.327960000000004;
                } else if (_padId === 67) {
                  _padVel = 12.264947200000002;
                  _padFlip = true;
                }
          ...
          if (!gameObj.activated && _needsClick) {
            if (_isDash) {
              ...
              if (_orbId === 1704 && gameObj._dashHoldTicks < 2) {} else if (_orbId === 1751 && gameObj._dashHoldTicks < 2) {
                gameObj.activated = true;
                this.p.yVelocity *= 0.5;
                this.flipGravity(!this.p.gravityFlipped);
                this.p.upKeyPressed = false;
              ...
              if (_orbId === 1594) {
                ...
                if (this.p.isFlying) {
                  if (_orbId === 36) {
                    ...
                    _orbVel = 8.273223680000001;
                  } else if (_orbId === 1333) {
                    _orbVel = 22.360064;
                  } else if (_orbId === 84) {
                    _orbVel = 8.944025600000002;
                    _flipAfter = true;
                  } else if (_orbId === 1022) {
                    _orbVel = -15.6520448;
                    _flipAfter = true;
                  ...
                  if (_orbId === 36) {
                    ...
                    _orbVel = 12.052074496000001;
                  } else if (_orbId === 1333) {
                    _orbVel = 20.973740032000002;
                  } else if (_orbId === 84) {
                    _orbVel = 6.260817920000001;
                    _flipAfter = true;
                  } else if (_orbId === 1022) {
                    _orbVel = -15.6520448;
                    _flipAfter = true;
        ...
        } else if (_colType === "hazard") {
          if (!window.noClip) {
            this.killPlayer();
          }
          return;
        } else if (_colType === "solid") {
          let _0x146a97 = _0x8e0d28 - 30 + _0x11ee2f;
          let _0x869e42 = _0x37040a - 30 + _0x11ee2f;
          let _0x3e7199 = _0x8e0d28 + 30 - _0x11ee2f;
          let _0x135a9d = _0x37040a + 30 - _0x11ee2f;
          const _0x3c1654 = _0x3c691e + 9 > left && _0x3c691e - 9 < right && _0x8e0d28 + 9 > top && _0x8e0d28 - 9 < bottom;
  ...
  drawHitboxes(graphics, camX, camY) {
    ...
    for (let _0x42ccb8 of _0x286071) {
      ...
      let _0x3e179d = 460 - _0x42ccb8.y + camY;
      let _0x17cd1a = 65280;
      if (_0x42ccb8.type === "hazard") {
        _0x17cd1a = 16729156;
      } else if (_0x42ccb8.type === "portal_fly" || _0x42ccb8.type === "portal_cube" || _0x42ccb8.type === "portal_ball" || _0x42ccb8.type === "portal_wave") {
        _0x17cd1a = 4491519;
        ...
        _0x17cd1a = 16744448;
      } else if (_0x42ccb8.type === "jump_pad") {
        _0x17cd1a = 16744192;
      } else if (_0x42ccb8.type === "jump_ring") {
        _0x17cd1a = 16711935;
      }
    ...
    const _0x7a132d = h;
    const _0x1e788a = 460 - _0x5e3ebe + camY;
    graphics.lineStyle(2, parseInt("00ffff", 16), 0.8);
    graphics.strokeRect(_0x7a132d - 30, _0x1e788a - 30, 60, 60);
    graphics.lineStyle(2, parseInt("ffff00", 16), 0.8);
    graphics.strokeRect(_0x7a132d - 30 + 5, _0x1e788a - 30, 50, 60);
    graphics.lineStyle(2, parseInt("ff0000", 16), 0.8);
    graphics.strokeRect(_0x7a132d - 30, _0x1e788a - 30 + 5, 60, 50);
    let _0x1eec42 = 460 - (_0x5e3ebe - 30 + _0x51832d) + camY;
    let _0xf6f69b = 460 - (_0x5e3ebe + 30 - _0x51832d) + camY;
    graphics.lineStyle(2, parseInt("ff8800", 16), 0.9);
    graphics.lineBetween(_0x7a132d - 30 - 8, _0x1eec42, _0x7a132d + 30 + 8, _0x1eec42);
    graphics.lineBetween(_0x7a132d - 30 - 8, _0xf6f69b, _0x7a132d + 30 + 8, _0xf6f69b);
    graphics.lineStyle(2, parseInt("ffffff", 16), 1);
  ...
  playEndAnimation(_0x24408e, _0x281588, _0x54bbf4) {
    ...
    _0x3729ef.tweens.add({
      ...
      onUpdate: () => {
        const _0x2478d6 = 1 * _0x4a45d7 + 0 * _0x4a45d7 + 0 * _0x1f2e19 + 0 * _0x457676;
        const _0x148e69 = 1 * _0x501b73 + 0 * _0x501b73 + 0 * _0x8bc9f4 + 0 * _0x3ade39;
        const _0x3d0365 = _0x2478d6 - _0x3729ef._cameraX;
        const _0x3790a9 = 460 - _0x148e69 + _0x3729ef._cameraY;
        ...
        for (const _0x2b394a of _0x3fc5a5) {
          ...
          _0x2b394a.spr.setAlpha(1);
        }
        _0x3e35e7.setPosition(_0x2478d6, 460 - _0x148e69);
...
class xs extends Phaser.Scene {
  ...
  create() {
    ...
    this._menuCameraX = -h;
    this._prevCameraX = -h;
    this._bg = this.add.tileSprite(0, 0, r, 640, "game_bg_01").setOrigin(0, 0).setScrollFactor(0).setDepth(-10);
    const _0x15d27a = this.textures.get("game_bg_01").source[0].height;
    this._bgInitY = _0x15d27a - 640 - 180;
    this._cameraX = -h;
    this._cameraY = 0;
    this._cameraXRef = {
      get value() {
    ...
    this._bg.setTint(this._colorManager.getHex(1000));
    this._level.setGroundColor(this._colorManager.getHex(1001));
    ...
    for (let _0xfeaf5c = 0; _0xfeaf5c < _0x4fc67f.length; _0xfeaf5c++) {
      ...
      const _0x1d293f = this.add.image(0, 0, "GJ_WebSheet", _0x1ce2a6.key + ".png").setScrollFactor(0).setDepth(30).setScale(0.6666666666666666).setInteractive();
    ...
    this._pauseBtn = this.add.image(r - 30, 30, "GJ_WebSheet", "GJ_pauseBtn_clean_001.png").setScrollFactor(0).setDepth(30).setAlpha(0.29411764705882354).setVisible(false);
    ...
    window.rightbuttoncallback = function () {
      ...
      index++;
      if (index >= window.allLevels.length || index < 0) {
        index = 0;
      }
    ...
    window.leftbuttoncallback = function () {
      ...
      index--;
      if (index >= window.allLevels.length || index < 0) {
        index = window.allLevels.length - 1;
      }
      window.currentlevel = [...window.allLevels[index]];
      window.scene.restart();
    };
    this._makeBouncyButton(this._leftBtn, 1, () => {
      window.leftbuttoncallback();
    }, () => this._menuActive);
    this._makeBouncyButton(this._rightBtn, 1, () => {
  ...
  _buildPauseOverlay() {
    ...
    const _0x505665 = this.add.rectangle(_0x13af33, 320, r, 640, 0, 0.29411764705882354);
    ...
    const _0x954813 = this._drawScale9(_0x13af33, 320, _0x4eb71b, 600, "square04_001", _0x103191, 0, 0.5882352941176471);
    ...
    const _0x38b8d1 = this.add.image(_0x13af33, 170, "GJ_WebSheet", "GJ_progressBar_001.png").setTint(0).setAlpha(0.49019607843137253);
    ...
    _0x3d0987.setPosition(_0x13af33 - _0xb5ab6f * 0.992 / 2, 170);
    this._pauseContainer.add(_0x3d0987);
    this._pauseContainer.add(this.add.bitmapText(_0x13af33, 170, "bigFont", _0x46bab2 + "%", 30).setOrigin(0.5, 0.5).setScale(0.7));
    ...
    const _0xe34699 = (_0x422be3, _0x4b32e0, _0xaaab25, _0x169b87) => {
      this._pauseContainer.add(this.add.image(_0x422be3 - 180 - 5, 500, "GJ_WebSheet", _0x4b32e0).setScale(1.2));
      const _0x51c57b = (_0x372782 - 8) * 0.7;
      const _0x34d1c1 = _0x422be3 - _0x372782 * 0.7 / 2 + 2.8;
      const _0xe86505 = _0xaaab25 * _0x51c57b;
      const _0x43dbf4 = this.add.tileSprite(_0x34d1c1, 500, _0xe86505 > 0 ? _0xe86505 : 1, 11.2, "sliderBar").setOrigin(0, 0.5).setVisible(_0xe86505 > 0);
      this._pauseContainer.add(_0x43dbf4);
      const _0x4de88c = this.add.image(_0x422be3, 500, "GJ_WebSheet", "slidergroove.png").setScale(0.7);
      this._pauseContainer.add(_0x4de88c);
      const _0x106f98 = _0x34d1c1 + _0xaaab25 * _0x51c57b;
      const _0x441360 = this.add.image(_0x106f98, 500, "GJ_WebSheet", "sliderthumb.png").setScale(0.7).setInteractive({
        draggable: true,
        useHandCursor: true
      });
  ...
  _buildInfoPopup() {
    ...
    const _0x249eb7 = this.add.rectangle(xPos, 320, r, 640, 0, 0.39215686274509803);
    _0x249eb7.setInteractive();
    this._infoPopup.add(_0x249eb7);
    const _0x14e46f = this.textures.get("GJ_square02").source[0].width * 0.325;
    const _0x2c64c2 = this._drawScale9(xPos, 320, 480, 336, "GJ_square02", _0x14e46f, 16777215, 1);
    ...
    yPos += 30;
    const _0x3cdf70c = this.add.bitmapText(xPos, yPos, "goldFont", "mod mod mod: Keih1Roblox", 40).setOrigin(0.5, 0.5).setScale(0.6);
  ...
  _positionMenuItems() {
    ...
    if (this._downloadBtns) {
      ...
      for (let _0x1bdfae = 0; _0x1bdfae < this._downloadBtns.length; _0x1bdfae++) {
        this._downloadBtns[_0x1bdfae].setPosition(_0x285ef7 - _0x1bdfae * 210, 555);
      }
    }
  }
  ...
  _applyScreenResize() {
    if (this.scale.isFullscreen) {
      ...
      l(Math.round(640 * _0x5bc34b));
    }
    this.scale.setGameSize(r, 640);
    this.scale.refresh();
    this._bg.setSize(r, 640);
  ...
  _updateCameraY(_0xc7c517) {
    ...
    if (this._level.flyCameraTarget !== null) {
      ...
      let _0x1f7976 = _0x29ed62 - 180 + 320;
      if (_0x2bc8fb > _0x1f7976 + 140) {
        _0x1a27be = _0x2bc8fb - 320 - 140 + 180;
      } else if (_0x2bc8fb < _0x1f7976 - 80) {
        _0x1a27be = _0x2bc8fb - 320 + 80 + 180;
      }
    }
    if (_0x1a27be < 0) {
      _0x1a27be = 0;
  ...
  update(_0x54fa47, _0xaf2ffd) {
    ...
    if (this._menuActive) {
      ...
      this._menuCameraX = (this._menuCameraX || 0) + _0x1e9cf4 * 11.540004 * 0.9 * 0.25;
    ...
    if (this._slideIn) {
      ...
      this._playerWorldX += _0x3c9318 * 11.540004 * 0.9;
      this._slideGroundX = (this._slideGroundX || this._cameraX) + _0x3c9318 * 11.540004 * 0.9 * 0.25;
    ...
    if (!this._levelWon && !this._state.isDead && this._level.endXPos > 0) {
      if (this._playerWorldX >= this._level.endXPos - 600) {
        this._levelWon = true;
    ...
    let _0x5dfd5a = _0x426602 * 11.540004 * 0.9;
    ...
    if (!this._endCameraOverride) {
      ...
      if (this._level.endXPos > 0) {
        ...
        if (_0xe48698 >= _0x24670d - 200) {
          ...
          const _0x41f777 = _0x2aca75 => _0x2aca75 < 0.5 ? Math.pow(_0x2aca75 * 2, 1.8) / 2 : 1 - Math.pow((1 - _0x2aca75) * 2, 1.8) / 2;
          this._endCamTween = {
            p: 0,
            fromX: this._cameraX,
            toX: _0x24670d,
    ...
    for (let _0x2001f6 of this._level.checkColorTriggers(_0x5464ab)) {
      ...
      if (_0x2001f6.tintGround) {
        this._colorManager.triggerColor(1001, _0x2001f6.color, _0x2001f6.duration);
      }
    }
  ...
  _levelComplete() {
    ...
    const _0x2d967b = 460 - this._endPortalGameY + this._cameraY;
  ...
  _showCompleteEffect() {
    ...
    (function (_0x3f5321, _0x8f5267, _0x2f1e2d, _0x4b5e5b) {
      const _0x232789 = Math.round(Math.sqrt(r ** 2 + 102400)) + 65;
      const _0x487fb1 = -135;
      ...
      let _0x594d69 = 0;
      const _0x116c8c = [];
      for (let _0x104cbb = 0; _0x104cbb < 8; _0x104cbb++) {
        const _0x1a79fc = _0x104cbb * 195 + 40 + 40 * (Math.random() * 2 - 1);
        const _0x6eb03a = 60 + 40 * (Math.random() * 2 - 1);
        const _0x2e9531 = 180 + 40 * (Math.random() * 2 - 1);
        const _0x28e7b3 = Math.min(1, Math.max(0, 0.6078431372549019 + 0.39215686274509803 * (Math.random() * 2 - 1)));
        const _0x34147c = _0x44369e[_0x104cbb] + 11.25 * Math.random() + 180;
        ...
        _0x3f5321.time.delayedCall(Math.max(0, _0x1a79fc), () => {
          ...
          _0x3f5321.tweens.add({
            ...
            onUpdate: () => {
              ...
              _0xf33b0d.beginPath();
              _0xf33b0d.moveTo(-1, 0);
              _0xf33b0d.lineTo(1, 0);
              _0xf33b0d.lineTo(1, 1);
              _0xf33b0d.lineTo(-1, 1);
              _0xf33b0d.closePath();
              _0xf33b0d.fillPath();
            }
      ...
      _0x3f5321.time.delayedCall(_0x594d69 + 400, () => {
    ...
    })(this, this._level.endXPos - this._cameraX + 60, 460 - this._endPortalGameY + this._cameraY, window.mainColor);
  ...
  _showCompleteText() {
    ...
    const _0x380b24 = 460 - this._endPortalGameY + this._cameraY;
  ...
  _showEndLayer() {
    ...
    const _0x384f9e = r / 2;
    this._endLayerOverlay = this.add.rectangle(_0x384f9e, 320, r, 640, 0, 0).setScrollFactor(0).setDepth(200).setInteractive();
    ...
    const _0x2a115c = (r - 712) / 2;
    this._endLayerInternal.add(this.add.rectangle(_0x2a115c + 356, 310, 712, 460, 0, 0.7058823529411765));
    const _0x43f2e3 = this.textures.getFrame("GJ_WebSheet", "GJ_table_side_001.png");
    const _0x3feccc = _0x43f2e3 ? 460 / _0x43f2e3.height : 1;
    ...
    this._endLayerInternal.add(this.add.image(_0x2a115c + 712 + 40, 80, "GJ_WebSheet", "GJ_table_side_001.png").setOrigin(1, 0).setFlipX(true).setScale(1, _0x3feccc));
    ...
    let _0xe44f6d = 250;
    const _0x2de55e = this.add.bitmapText(_0x384f9e, _0xe44f6d, "goldFont", "Attempts: " + this._attempts, 40).setOrigin(0.5, 0.5).setScale(0.8);
    this._endLayerInternal.add(_0x2de55e);
    _0xe44f6d += 48;
    this._endLayerInternal.add(this.add.bitmapText(_0x384f9e, _0xe44f6d, "goldFont", "Jumps: " + this._totalJumps, 40).setOrigin(0.5, 0.5).setScale(0.8));
    _0xe44f6d += 48;
    ...
    this._endLayerInternal.add(this.add.bitmapText(_0x384f9e, _0xe44f6d, "goldFont", "Time: " + _0x2be782, 40).setOrigin(0.5, 0.5).setScale(0.8));
    ...
    this._endLayerInternal.add(this.add.bitmapText(_0x384f9e + 225, _0x241209, "bigFont", _0x165c06, 40).setOrigin(0.5, 0.5).setScale(0.8).setCenterAlign());
    this._endLayerInternal.add(this.add.image(_0x384f9e - 225, 352.5, "GJ_WebSheet", "getIt_001.png").setScale(0.6666666666666666));
    const _0x34b1bd = [{
      key: "downloadApple_001",
      url: "https://discord.gg/TfEzAVWPSJ"
    }, {
    ...
    for (let _0x10f8cc = 0; _0x10f8cc < _0x34b1bd.length; _0x10f8cc++) {
      ...
      const _0x1e3f82 = (_0x10f8cc - 1) * 225;
  ...
  _playStarAward() {
    ...
    this.time.delayedCall(100, () => {
      ...
      this.tweens.add({
        ...
        onUpdate: () => {
          _0x43203f.clear();
          _0x43203f.fillStyle(16776960, 1);
...
function ws(_0x13c75c, _0x23c5aa = 16777215, _0x52bb5b = 16777215) {
  const _0x4eb200 = 200 + (r - 400) * Math.random();
  const _0x126811 = 200 + Math.random() * 240;
